    ...
    <main>
      <div class="big-wrapper light">
          ...
          <div class="container">
            ...
            <div class="navbar">
              <ul>
                ...
                <li><a href="edit.php" class="link">Edit</a></li>
                <li><a href="./php/logout.php" class="link">Logout</a></li>
              </ul>
            </div>
          ...
          <div class="container">
            <div class="left">
              ...
              <div data-aos="fade-down">
                  <a href="login1.php" target="blank"><button type="submit">Login</button></a>
              </div>
            </div>
        ...
        <h3 class="pre-title">The CEO is</h3>
            ...
            <br/>
            <h3><a href="#" style="color:#3a4d39" class="my-profile"><i class="fas fa-user" aria-hidden="true"></i>   Check My Profile</a><h3>
            <ul class="social">
